 ...
 * <p>
 * Implement at least {@linkplain #neighbors(pp.util.WithDistance)} and
 * {@linkplain #addedCosts(pp.util.WithDistance, pp.util.WithDistance, pp.util.WithDistance)} in a concrete subclass.
 *
 * @param <N> the type of each node in the graph. It must at least implement {@linkplain pp.util.WithDistance}
 */
